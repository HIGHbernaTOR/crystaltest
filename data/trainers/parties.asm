...
FalknerGroup:
	...
	db   7,  MURKROW,    PECK, MUD_SLAP, NO_MOVE, NO_MOVE
	db   9,  PIDGEOTTO,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db  10,	 NOCTOWL,	 PECK, WHIRLWIND, REFLECT, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 18, TEDDIURSA,  FURY_SWIPES, HEADBUTT, REST, SNORE
...
BugsyGroup:
	...
	db 14, LEDYBA,     TACKLE, SUPERSONIC, LIGHT_SCREEN, NO_MOVE
	db 14, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, WHIRLWIND, NO_MOVE
...
MortyGroup:
	...
	db 23, MISDREAVUS, SPITE, MEAN_LOOK, CONFUSE_RAY, PSYBEAM
	db -1 ; end
...
PryceGroup:
	...
	db 30, DELIBIRD,   PRESENT, ICY_WIND, DOUBLE_TEAM, PROTECT
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 32, SKARMORY,   AGILITY, STEEL_WING, DRILL_PECK, PURSUIT
...
ChuckGroup:
	...
	db 25, TYROGUE,    TACKLE, HEADBUTT, ENDURE, KARATE_CHOP
	db 27, PRIMEAPE,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 27, HITMONTOP,  ROLLING_KICK, RAPID_SPIN, ENDURE, PURSUIT
...
ClairGroup:
	...
	db 37, SEADRA,     SMOKESCREEN, SURF, TWISTER, DRAGONBREATH
	db 37, GYARADOS,   DRAGON_RAGE, WATERFALL, CRUNCH, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 40, KINGDRA,    OCTAZOOKA, SURF, AURORA_BEAM, DRAGONBREATH
	db -1 ; end
...
LassGroup:
	...
	; LASS (17)
	db "DANA@", TRAINERTYPE_MOVES
	db 36, AMPHAROS,   PLAY_ROUGH, THUNDERPUNCH, THUNDER_WAVE, COTTON_SPORE
