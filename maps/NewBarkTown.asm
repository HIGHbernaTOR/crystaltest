...
NewBarkTown_MapEvents:
	...
	bg_event 19, 13, BGEVENT_READ, NewBarkTownElmsHouseSign
	...
	object_event  0, 13, SPRITE_UNUSED_GUY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, NewBarkTownFriendshipTesterScript, -1
